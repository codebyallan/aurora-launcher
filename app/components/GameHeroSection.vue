    ...
    <Transition enter-active-class="transition duration-700 ease-out delay-150"
      ...
      <div :key="`details-${itemKey}`" class="flex flex-col items-start gap-3">
        ...
        <div class="flex gap-3 items-center">
          ...
          <GameContextMenu :open="controllerMenuOpen" :controller-focus-index="controllerMenuFocusIndex"
            @edit="$emit('edit')" @delete="$emit('delete')" @open="$emit('controller-menu-open')"
